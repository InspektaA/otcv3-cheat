var screen_width = Math.round(Render.GetScreenSize()[0]);
...
{
    var colors = HSVtoRGB(Globals.Realtime() * UI.GetValue("MISC", "JAVASCRIPT", "Script Items", "Rainbow Line Speed"), 1, 1);
...
Cheat.RegisterCallback("Draw", "onDrawEvent");
